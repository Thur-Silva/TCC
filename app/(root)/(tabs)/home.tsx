...
import { getEnderecoAtual } from '@/services/getEnderecoAtual';
...
export default function Page() {
  ...
  useEffect(() => {
    (async () => {
      ...
      const endereco = await getEnderecoAtual({ latitude, longitude });

      setUserLocation({
        latitude,
        longitude,
        address: endereco?.exibicaoCompleta || 'Endereço não encontrado',
      });
    })();
  }, []);
