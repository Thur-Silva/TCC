...
type Props = {
  ...
  setOrigin: (coord: Coordenada) => void
  setDestination: (coord: Coordenada) => void
  ...
  <View className="bg-[#e6f0ff] rounded-2xl px-4 py-6 space-y-6 border border-[#d0e2f7]">
    ...
    <View className="space-y-2">
      ...
      >
        ...
        >
          {onlyFree ? '✓ ' : ''}Somente coridas grátis
        </Text>
      </Pressable>
    </View>
          ...
          {loading ? (
            ...
            <View className="space-y-4">
              {topRides.map((ride) => (
                ...
                >
                  <View>
                    <Text className="text-base font-JakartaBold text-[#1A73E8]">
